...
KITS: dict[str, dict[str, list[tuple[str, float]]]] = {
    ...
    "garage:crewdark": {     # So Solid — sparse dark, tight pitched-up hits
        ...
        "hatC":  [("garage/crewdark/hatC.wav", 1.25)],
    ...
    "garage:partybounce": {  # Heartless — bright 4x4 bounce, tambourine top
        ...
        "hatC":  [("garage/partybounce/hatC.wav", 1.25)],
    ...
    "garage:stabriddim": {   # More Fire — harder kicks, proto-grime snap
        ...
        "hatC":  [("garage/stabriddim/hatC.wav", 1.25)],
        "hatO":  [("garage/stabriddim/hatO.wav", 1.15)],
